...
describe('An inventory system ...', function () {
  ...
  itskip("test_conjured_item_before_sell_date", function () {
  ...
  itskip("test_conjured_item_at_zero_quality", function () {
  ...
  itskip("test_conjured_item_on_sell_date", function () {
  ...
  itskip("test_conjured_item_on_sell_date_at_zero_quality", function () {
  ...
  itskip("test_conjured_item_after_sell_date", function () {
  ...
  itskip("test_conjured_item_after_sell_date_at_zero_quality", function () {
